...
jQuery(function() {
  var $module = jQuery('#m-1618323265784').children('.module');

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'production') { 
    $module.children('form').on('submit', function() {
      try {
        localStorage.setItem('gemId', '#m-1618323265784');
      } catch(err) {}
    });
    ...
    window.__gfAnimate.registerHover(jQuery("#e-1618323265784-31"), '{"animation":{"screens":{"lg":true,"md":true,"sm":true,"xs":false},"name":"pulse","delay":300,"duration":500,"iteration-count":"1"},"interaction":{"key":"mouse-hover","type":"level2"}}');window.__gfAnimate.registerPageLoaded(jQuery("#e-1618323265784-31"), '{"animation":{"screens":{"lg":false,"md":false,"sm":false,"xs":true},"name":"pulse","delay":300,"duration":500,"iteration-count":"infinite"},"interaction":{"key":"after-page-loaded","type":"level2"}}');